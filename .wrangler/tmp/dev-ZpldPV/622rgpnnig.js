...
// .wrangler/tmp/bundle-WheNS9/checked-fetch.js
...
// .wrangler/tmp/pages-i27v4R/bundledWorker-0.8101886312302717.mjs
...
var oe = /* @__PURE__ */ __name2((e, t, a, r) => {
  if (t && typeof t == "object" || typeof t == "function") for (let i of ie(t)) !ce.call(e, i) && i !== a && H(e, i, { get: /* @__PURE__ */ __name2(() => t[i], "get"), enumerable: !(r = se(t, i)) || r.enumerable });
  return e;
}, "oe");
var V = /* @__PURE__ */ __name2((e, t, a) => (a = e != null ? ae(ne(e)) : {}, oe(t || !e || !e.__esModule ? H(a, "default", { value: e, enumerable: true }) : a, e)), "V");
var y;
var l = E(() => {
  y = { collectedLocales: [] };
});
...
async function Z(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let n = globalThis[he], s = /* @__PURE__ */ __name2(async () => {
          let c = await e.json();
...
function Ee() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, a) => e.has(a) ? e.get(a) : Reflect.get(globalThis, a), "get"), set: /* @__PURE__ */ __name2((t, a, r) => Me.has(a) ? Reflect.set(globalThis, a, r) : (e.set(a, r), true), "set") });
}
__name(Ee, "Ee");
__name2(Ee, "Ee");
...
// .wrangler/tmp/pages-i27v4R/622rgpnnig.js
...
// .wrangler/tmp/bundle-WheNS9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-WheNS9/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=622rgpnnig.js.map
