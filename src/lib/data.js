export const girls = [
  ...
  {id: 87,
    ...
    description: {
      en: "Sweet, gorgeous, and incredibly tall, Jianyi is a 21-year-old local undergraduate companion now serving CBD Auckland. Boasting top-tier looks resembling celebrity Yang Mi, a flawless fair complexion, and an impressive 171cm stature with natural D+ cup curves, she is an absolute dream companion. Her standard package ($700/1h) includes double shower play, water BJ, deep French kissing, stocks, breast massage, mutual oral (69), stockings, natural BJ, and 1 round. Upgrade to a second round for an extra $100. Cash only.",
