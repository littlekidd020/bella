      ...
      <AnimatePresence>
        {!verified && (
          <motion.div
            ...
            className="fixed inset-0 z-[200] bg-blush flex flex-col font-sans overflow-hidden"
          >
            ...
            <div className="absolute inset-0">
               <motion.img 
                 ...
                 alt="Luxury Entry"
               />
               <div className="absolute inset-0 bg-gradient-to-b from-blush via-transparent to-blush" />
