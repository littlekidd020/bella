    ...
    <header className={`fixed top-4 md:top-6 left-4 right-4 z-[70] mx-auto max-w-7xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
      ...
      <div className={`fixed inset-0 bg-[#FAF5F7]/95 backdrop-blur-3xl z-[75] transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col items-center justify-center gap-12 ${isOpen ? 'opacity-100 pointer-events-auto translate-y-0' : 'opacity-0 pointer-events-none -translate-y-4'}`}>
        ...
        <button 
          ...
          className="flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#F84A88] to-[#C5A059] text-white rounded-full font-bold tracking-widest shadow-[0_0_20px_rgba(248,74,136,0.3)] hover:shadow-[0_0_30px_rgba(248,74,136,0.5)] transition-shadow duration-300"
        >
          <Globe size={20} />
