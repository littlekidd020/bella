  ...
  return (
    <footer className="px-8 py-24 flex flex-col items-center gap-6 text-center text-white/30 uppercase tracking-[0.5em] font-sans border-t border-white/5 bg-[#3D0A1E]">
      <div className="flex flex-col items-center gap-6">
        ...
        <img src="/images/logo.png" alt="Angel Cuties Logo" className="w-12 h-12 object-contain opacity-50 hover:opacity-100 transition-opacity duration-700" style={{ mixBlendMode: 'screen' }} />
