...
export default function ContactBanner() {
  ...
  return (
    <motion.div 
      ...
      className={`relative z-20 w-[calc(100%-4rem)] md:w-[96%] max-w-7xl mx-auto mb-6 md:mb-8 rounded-[2rem] md:rounded-full bg-gradient-to-r from-[#F84A88]/80 via-[#e23773]/80 to-[#D41E5D]/80 backdrop-blur-md border border-white/20 overflow-hidden shadow-[0_10px_40px_rgba(248,74,136,0.3)] ${shouldHideOnMobile ? 'hidden md:block' : ''}`}
    >
