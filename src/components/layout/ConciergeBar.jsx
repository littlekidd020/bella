  ...
  return (
    <>
      <motion.div 
        initial={{ y: 100 }}
        animate={{ y: 0 }}
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-8 py-3 bg-[#2b0817]/60 backdrop-blur-xl border border-[#F84A88]/20 rounded-full shadow-[0_0_30px_rgba(225,29,72,0.1)] flex items-center gap-5 md:gap-10"
    >
      ...
      <a href="https://line.me/ti/p/angle666akl" className="flex flex-col items-center gap-1 group">
        ...
        <span className="text-[9px] uppercase tracking-wider text-[#F84A88]/60 group-hover:text-[#F84A88] transition-colors font-sans whitespace-nowrap">{t.concierge.sticky.line}</span>
      </a>
