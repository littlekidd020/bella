...
const ConciergeBar = () => {
  ...
  return (
    ...
    >
      <a href="tel:+640000000" className="flex flex-col items-center gap-1 group">
      ...
      <a href="https://wa.me/640000000" className="flex flex-col items-center gap-1 group">
        <div className="p-2 rounded-full group-hover:bg-[#F84A88]/10 transition-colors">
      ...
      <a href="https://t.me/boutiquecollection" className="flex flex-col items-center gap-1 group">
        <div className="p-2 rounded-full group-hover:bg-[#F84A88]/10 transition-colors">
