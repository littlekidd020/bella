...
const StatItem = ({ icon: Icon, label, value, t }) => {
  const displayValue =
    typeof value === "string"
      ...
      : value;
  return (
    <div className="flex flex-col gap-2.5 p-5 md:p-6 rounded-2xl bg-[#F84A88]/8 backdrop-blur-md border border-[#F84A88]/15 shadow-[var(--shadow-soft)] hover:-translate-y-0.5 transition-all duration-500">
          ...
          <div className="sticky top-32 space-y-8">
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-6">
                ...
                <p className="text-[10px] uppercase tracking-[0.3em] text-[#F84A88] font-bold font-sans">
            ...
            <div className="pt-8 border-t border-[#2D1822]/5 relative">
              <div className="space-y-8">
                <div>
                  ...
                  <div className="flex flex-col gap-3 bg-[#F84A88]/8 backdrop-blur-md border border-[#F84A88]/15 shadow-[var(--shadow-soft)] rounded-2xl p-5 md:p-6">
                        ...
                        return (
                          <React.Fragment key={groupIdx}>
                            ...
                            <span className="inline max-w-full">
                              <span className="whitespace-normal break-words px-3.5 py-1.5 bg-[#F84A88]/12 border border-[#F84A88]/15 text-[#2D1822]/65 rounded-full inline-block text-[13px] shadow-sm">
      ...
      >
        <div className="max-w-[1400px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="hidden md:flex flex-col gap-1">
            ...
            <p className="text-[9px] text-[#F84A88] uppercase tracking-widest font-bold font-sans">
          ...
          <div className="flex flex-wrap sm:flex-nowrap w-full md:w-auto items-center gap-3">
            ...
            <button
              ...
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-8 py-3 bg-[#F84A88] text-white rounded-xl hover:bg-[#D41E5D] transition-all duration-300"
            >
