      ...
      <header className="relative w-full min-h-[auto] lg:min-h-screen flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-12 gap-12 pt-32 lg:pt-40 flex-1 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center space-y-0 lg:space-y-8 z-20 order-2 lg:order-1 pb-0 lg:pb-0 text-center lg:text-left items-center lg:items-start">
            <p className="hidden lg:block text-[10px] uppercase tracking-[0.4em] text-[#C5A059] font-sans font-bold mb-6">{t.hero.bespokeCompanions || "BESPOKE COMPANIONS"}</p>
            ...
            <p className="hidden lg:block text-[#2D1822]/60 text-sm md:text-base font-sans tracking-[0.1em] leading-relaxed max-w-md border-l border-[#C5A059]/40 pl-6">
              {lang === "cn" ? 
            ...
            <div className="hidden lg:flex pt-0 lg:pt-4 w-full justify-center lg:justify-start">
              <Link 
                href="/collection" 
                className="group relative inline-block text-center border border-[#F84A88]/30 hover:border-[#F84A88] w-full max-w-[300px] md:max-w-[340px] py-3.5 md:py-4 transition-all duration-500 overflow-hidden rounded-full"
              >
          ...
          {/* Masked Image Panel */}
          <div className="hidden lg:block lg:col-span-7 relative h-[50vh] lg:h-[80vh] w-full rounded-[60px] overflow-hidden border border-[#C5A059]/20 shadow-[0_20px_50px_rgba(197,160,89,0.10)] order-1 lg:order-2">
            <img 
        ...
        <div className="w-full mt-auto pt-0 lg:pt-16 relative z-20">
          <ContactBanner />
        </div>
      </header>
      ...
      <section className="relative px-6 md:px-10 pt-12 md:pt-12 pb-32 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="card-elevated rounded-3xl p-10 md:p-12 flex flex-col items-start gap-4 group hover:-translate-y-1 transition-all duration-500">
            <div className="w-14 h-14 rounded-full bg-[#F84A88]/5 flex items-center justify-center text-[#C5A059] mb-4 group-hover:scale-110 transition-transform">
