...
const ConciergePage = () => {
  ...
  const Feature = ({ icon: Icon, title, desc }) => (
    <div className="card rounded-2xl p-8 flex flex-col gap-4 hover:-translate-y-1 transition-all duration-500">
      <div className="w-12 h-12 rounded-full bg-[#F05C88]/10 flex items-center justify-center text-[#F05C88]">
        <Icon size={24} />
      </div>
      <h3 className="text-xl font-serif text-[#593A48] font-playfair">{title}</h3>
      <p className="text-sm text-[#593A48]/55 leading-relaxed font-sans">{desc}</p>
    </div>
  );
    ...
    <main className="min-h-screen bg-[#FFE3EC] transition-colors duration-700">
      ...
      <section className="max-w-7xl mx-auto py-8 md:py-16 px-8">
        ...
        <div className="max-w-4xl mx-auto rounded-3xl overflow-hidden relative">
          <div className="absolute inset-0 bg-[#F05C88]/15 blur-3xl rounded-full" />
          <div className="relative card-elevated rounded-3xl p-12 text-center flex flex-col items-center">
            <h2 className="text-3xl font-serif text-[#593A48] mb-8 font-playfair tracking-wide italic">{t.concierge.ctaTitle}</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
              <a 
                href="https://wa.me/64225391339"
                className="flex items-center justify-center gap-3 py-4 bg-[#F05C88] text-white rounded-xl hover:bg-[#A98442] transition-all transform hover:scale-105 shadow-[0_0_30px_rgba(240,92,136,0.3)]"
              >
              ...
              <a 
                ...
                className="flex items-center justify-center gap-3 py-4 bg-[#FFFFFF]/60 border border-[#F05C88]/30 text-[#593A48] rounded-xl hover:bg-[#FFFFFF]/80 transition-all transform hover:scale-105"
              >
                <Send size={18} />
                <span className="text-[10px] uppercase tracking-[0.2em] font-bold font-sans">Telegram</span>
              </a>
              <div className="flex items-center justify-center gap-3 py-4 bg-[#FFFFFF]/60 border border-[#F05C88]/30 text-[#593A48] rounded-xl hover:bg-[#FFFFFF]/80 transition-all transform hover:scale-105 cursor-pointer">
                <span className="text-[10px] uppercase tracking-widest text-[#F05C88] font-bold font-sans">微信在线客服</span>
                <span className="text-[11px] uppercase tracking-[0.2em] font-black font-sans">Angelya3312</span>
              </div>
              <div className="flex items-center justify-center gap-3 py-4 bg-[#FFFFFF]/60 border border-[#F05C88]/30 text-[#593A48] rounded-xl hover:bg-[#FFFFFF]/80 transition-all transform hover:scale-105 cursor-pointer">
                <span className="text-[10px] uppercase tracking-widest text-[#F05C88] font-bold font-sans">微信防走失</span>
                <span className="text-[11px] uppercase tracking-[0.2em] font-black font-sans">nice325888</span>
              </div>
              <div className="flex items-center justify-center gap-3 py-4 bg-[#FFFFFF]/60 border border-[#F05C88]/30 text-[#593A48] rounded-xl hover:bg-[#FFFFFF]/80 transition-all transform hover:scale-105 cursor-pointer">
                <span className="text-[10px] uppercase tracking-widest text-[#F05C88] font-bold font-sans">微信备用号</span>
                <span className="text-[11px] uppercase tracking-[0.2em] font-black font-sans">hjmgrdss</span>
              </div>
              <div className="flex items-center justify-center gap-3 py-4 bg-[#FFFFFF]/60 border border-[#F05C88]/30 text-[#593A48] rounded-xl hover:bg-[#FFFFFF]/80 transition-all transform hover:scale-105 cursor-pointer">
                <span className="text-[10px] uppercase tracking-widest text-[#F05C88] font-bold font-sans">微信客服2</span>
                <span className="text-[11px] uppercase tracking-[0.2em] font-black font-sans">Angel91339</span>
              </div>
              <a 
                href="https://line.me/ti/p/angle666akl"
                className="flex items-center justify-center gap-3 py-4 bg-[#FFFFFF]/60 border border-[#F05C88]/30 text-[#593A48] rounded-xl hover:bg-[#FFFFFF]/80 transition-all transform hover:scale-105"
              >
                <span className="text-[10px] uppercase tracking-widest text-[#F05C88] font-bold font-sans">LINE 咨询</span>
            ...
            <p className="mt-8 text-[10px] text-[#593A48]/40 uppercase tracking-[0.3em] font-sans italic">
