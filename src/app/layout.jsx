...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body suppressHydrationWarning className={`${montserrat.variable} ${cormorant.variable} ${notoSansCN.variable} ${notoSerifCN.variable} font-sans antialiased bg-[#FFE3EC] text-[#593A48]`}>
        <LanguageProvider>
          <AgeGate>
            <Navbar />
            {children}
